...
Set "Dafile=%Final_location%\%Portfolio_Folder%\%subject%\Project.md"
Type "%Dafile%"
echo.
Echo Leave your comments, enter "wq" back to main menu.
:Leave_a_Comments
Set /p comments=
if "%comments%"=="wq" (
	goto open
...
if Not "%comments%"=="" (
	Echo TimeStamp: %date% %Time% - %comments%>>"%Dafile%"
)
